...
<%def name="extJavaScript()">
    ...
    //<![CDATA[
	    ...
	    function toSearch(){
	       $(".searchform").attr("action","/logic/index");
	       $(".searchform").submit()
	    }
	    
	    function toExport(){
	    	$(".searchform").attr("action","/logic/export");
	    	$(".searchform").submit()
	    }
    ...
    <table class="gridTable" cellpadding="0" cellspacing="0" border="0" style="width:1350px">
        ...
        <tbody>
            ...
            %else:
                %for obj in result:
                <tr>
                    <td class="bl"><a href="/logic/detail?id=${obj.id}">${obj.systemNo}</a></td>
                    <td>${obj.jobNo}</td>
                    <td>${obj.itemCode}</td>
                    <td>${obj.brand}</td>
                    <td>${obj.developer}</td>
...
<div id="new-item-div" title="Create New Item">
    ...
    <table >
        ...
        <tr>
            <td valign="top">BBB Item Code</td>
            <td><input type="text" name="f_itemCode" id="f_itemCode"/></td>
        </tr>
        <tr>
            <td valign="top">Brand</td>
            <td><input type="text" name="f_brand" id="f_brand"/></td>
        </tr>
        <tr>
            <td valign="top">BBB developer</td>
            <td><input type="text" name="f_developer" id="f_developer"/></td>
        </tr>
        <tr>
